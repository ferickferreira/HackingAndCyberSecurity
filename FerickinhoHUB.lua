...
local function initializeGui()
	...
	addButton("Hitbox Expander", function()
    	loadstring(game:HttpGet("https://raw.githubusercontent.com/ferickinhoferreira/HackingAndCyberSecurity/refs/heads/main/Hitbox%20Expander.lua"))()
    	print("Hitbox Expander: Executado")
	end, false)
